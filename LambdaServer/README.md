# LambdaServer serverless API
The LambdaServer project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "LambdaServerApi",  
                    "OutputKey": "LambdaServerApi",
